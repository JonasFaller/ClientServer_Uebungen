...
public class ServerEinzelnerThreadU7 
{
    public static void main(String args[]) throws IOException, InterruptedException
    {
        ...
        while (true)
        {
            ...
            if(clienteingabe.toLowerCase().equals("beenden"))//Wenn Client beenden ausgewählt hat wird beendet
            {
            	// Beenden
            	break;
            }
            else if (clienteingabe.toLowerCase().equals("zeit"))//Wenn Client zeit ausgewählt hat wird die zeit mit der Funktion getTime 
